...
jQuery.imageMagnify = {
    ...
    cursorcss: 'url(magnify/magnify.cur), -moz-zoom-in', //Value for CSS's 'cursor' attribute, added to original image
    zIndexcounter: 100,
    ...
    magnify: function($, $target, options) {
	    ...
	    $('#float').css('z-index', 1)  //* DIMA 10-10-2015 *//
            $clone.stop().css({
        ...
        $clone.click(function(e) { //action when magnified image is clicked on
            ...
            $this.stop().animate({
                ...
                function() {
		    $('#float').css('z-index', 20001)  //* DIMA 10-10-2015 *//
                    $this.hide()

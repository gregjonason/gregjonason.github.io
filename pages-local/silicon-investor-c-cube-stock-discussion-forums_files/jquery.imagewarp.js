...
jQuery.imageWarp = {
    ...
    addEffect: function($, $target, options) {
        ...
        var newattrs = {
            w: Math.round(attrs.w * setting.warpfactor),
        ...
        this.warpshells.push({
            $clone: $clone,
            attrs: attrs,
            newattrs: newattrs,
            $link: ($targetlink.length == 1) ? $targetlink : null
        }) //remember info about this warp image instance
        $target.click(function(e) {
            var $this = $(this).css({
                opacity: setting.imgopacity[0]
            })
            ...
            $clone.stop().css({
                ...
                opacity: setting.warpopacity[0],
                visibility: 'visible',
            })
                .animate({
                        opacity: setting.warpopacity[1],
